...
-- Populated by cleanbill/etl/publish.py for published leads only (~16.8K properties × ~6 units). entity_cd is TCAD's own code
-- (e.g. 01 = Austin ISD, 02 = City of Austin, 03 = Travis County, 68 = ACC, 2J = Central Health); the same codes key
-- cleanbill/estimator/rates/units.json. Applied to the hosted project 2026-09-13 (version 20260913205914).
