...
| `trd/brand.py`, `trd/fonts/`, `trd/email/` | The design-system adapters (SPEC-08 Part C): `brand_tokens.py` generated from `apps/web/src/styles/tokens.css`, the vendored DM Sans (OFL), the mark geometry, the e-mail template. |
