...
- [0023](./0023-mail-batch-stratified-seeded-selection-lob-verification-mail-pieces-signed-webhooks.md) — mail batch: stratified seeded selection from the published leads, Lob address verification before render, one `mail_pieces` row per piece, denormalised lead status, signed webhooks (2026-09-18)
