...
export function DesignSystem() {
  ...
  return (
    <div className="wrap" style={{ paddingTop: 24, paddingBottom: 80 }}>
      ...
      <Section id="email" title="E-mail template" sub="cleanbill/email/base.html rendered with a sample message (public/brand/email-sample.html). Every outbound e-mail (the /ops Send, SPEC-10) is wrapped in it; the Deno renderer matches the Python one byte for byte.">
