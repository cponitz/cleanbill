...
def main() -> int:
    ...
    ap.add_argument("--claim", default=None, help="run for one claim id")
    ...
    customers = [store.get_claim(a.claim)["claim"]] if a.claim else store.list_claims(a.statuses.split(","))
    ...
    for c in customers:
        ...
        results.append({"claim_id": c["id"], "start_status": c["status"], "turns": r.turns, "cost_usd": r.cost_usd,
